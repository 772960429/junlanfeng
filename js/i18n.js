...
const translations = {
    ...
    zh: {
        ...
        // 首页
        'about.title': '关于我',
        'about.intro': '人工智能科学家和技术领导者，在对话式人工智能、网络智能、人工智能平台及安全基础模型等领域深耕近30年。现任中国移动集团首席科学家，曾任全球最大开源网络社区LF Networking董事会主席。带领团队开展九天人工智能平台及基础模型技术研发，相关成果已支撑4000余个生产应用场景，覆盖9个行业的30余家政企客户，服务用户超过10亿。',
        'about.research': '学术研究：', 
        'about.research.text': '发表学术论文200余篇，引用次数6800余次；拥有授权专利100余项，在审专利申请200余项；参与著书一部。',
        'about.leadership': '领导力与影响：',
        'about.leadership.text': '获得20余项奖项；作大会主旨报告和特邀报告100余场；支撑4000余个人工智能生产应用场景；完成30余项重大企业级部署。',
        'about.tech.leadership': '研究与技术领导力：',
        'about.conversational.ai': '对话式人工智能：',
        'about.conversational.ai.text': '在 AT&T Labs Research工作期间，开创性研发了WebTalk系统，这是一个早期可基于网页内容自动构建对话服务的系统。随后，领导中国移动客户服务智能化项目，包括Eva智能客服系统。',
        'about.network.intelligence': '网络智能：',
        'about.network.intelligence.text': '领导中国移动网络智能化项目和自智网络关键技术研发，支撑自智网络能力演进和大规模智能化运维。',
        'about.jiutian': '九天人工智能平台与基础模型：',
        'about.jiutian.text': '担任九天人工智能平台、九天人工智能中台和九天基础模型核心技术总工程师。该平台支撑人工智能在通信、能源、化工、航空、医疗健康、政务服务等行业的大规模生产应用部署。',
        ...
        'pub.1.detail': 'COLING, 2010; 被引用1430+次。',
        'pub.2': '基于深度强化学习的网络拓扑优化',
        'pub.2.detail': 'IEEE Transactions on Communications, 2023; 被引用61次，影响因子: 8.3。',
        'pub.3': '网络遇见ChatGPT：意图自治管理、控制与运营',
        'pub.3.detail': 'Journal of Communications and Information Networks, 2023; 被引用84次，影响因子: 4.7。',
        'pub.4': '用于多类型锂离子电池鲁棒荷电状态估计的混合提示驱动大语言模型',
        'pub.4.detail': '2024; 被引用35次，影响因子: 9.78。',
        'pub.5': '基于Transformer的多模态预训练模型综述',
        'pub.5.detail': 'Journal of Neurocomputing, 2023; 被引用65次，影响因子: 6.5。',
        'pub.6': '耦合图上的联邦学习',
        'pub.6.detail': '2023; 被引用51次，影响因子: 7.27。',
        'pub.7': '蜂窝流量预测中的深度学习综述',
        'pub.7.detail': 'Intelligent Computing (Science Partner Journals), 2024; 被引用52次，影响因子: 3.7。',
        'pub.8': 'JT-SAFE-V2：采用世界上下文数据的安全内生基础模型',
        'pub.8.detail': 'arXiv:2605.24414, 2026.6',
        'pub.9': '使用改进K-Shell分解衡量Twitter用户影响力',
        'pub.9.detail': 'AAAI, 2021; 被引用123次。',
        'pub.10': '基于概率模型的Twitter消息情感分析',
        'pub.10.detail': '2010 IEEE SLT; 被引用121次。',
        'pub.11': '长上下文语言建模综合综述',
        'pub.11.detail': 'arXiv:2503.17407, 2025; 被引用117次。',
        'pub.12': '面向用药推荐的深度学习系统综述',
        'pub.12.detail': 'Journal of Data Intelligence, 2023; 被引用74次。',
        ...
        'pat.7': '一种基于状态感知的对抗生成闭环方案',
        'pat.7.detail': 'YF2401070',
        'pat.8': '一种流式噪声标签检测方法',
        'pat.8.detail': 'YF2310321',
        'pat.9': '一种基于Decoder的生成式网络预训练大模型架构',
        'pat.9.detail': 'YF2309241',
        'pat.10': '一种面向通信网络软件研运一体化的上下文编排管理方法',
        'pat.10.detail': 'YF2210005',
        'pat.11': '体系化智能的方法、系统、框架、设备和装置',
        'pat.11.detail': 'YF2207055',
        'pat.12': '一种基于规划的稳健多动作对话策略模型及系统',
        'pat.12.detail': 'YF2110069',
        ...
        'edu.3': '1990-1995：山西财经大学',
        'edu.3.detail': '信息管理系',
        'leadership.title': '专业领域领导力',
        ...
        'proj.1': '2024-2025：安全可信基础大模型（JT-Safe）项目负责人，项目团队360余人',
        'proj.2': '2022-2025：国家新一代人工智能开放创新平台项目负责人，项目团队150余名研究人员和工程师',
        'proj.3': '2022-2026：多媒体信息处理全国重点实验室理事会理事，实验室技术人员190余人',
        'proj.4': '2019-2022：开放协同可控的软件定义网络关键技术与系统项目“跨域智能编排平面”课题负责人',
        'proj.5': '2020-2023：拟人化人机交互服务关键技术与系统项目技术负责人',
        'projects.enterprise': '近三年承担的大规模重点企业级及商业项目',
        'ent.1': '2024-2025：技术总负责，中国石油AI中台及多模态基础模型',
        'ent.2': '2025-2026：技术总负责，中国化工集团行业模型及平台',
        'ent.3': '2020-2025：技术总负责，中国移动网络智能化转型',
        'ent.4': '2023-2026：技术总负责，九天基础模型',
        'ent.5': '2020-至今：技术总负责，中国移动九天人工智能平台与中台',
        'ent.6': '2021-2022：技术总负责，东方航空公司平台及基座模型',
        'ent.7': '2024-2026：技术总负责，中国航信AI平台及客服',
        'ent.8': '2023-2025：技术总负责，医院AI平台与能力',
        ...
        'awd.5': '自智网络关键技术及规模应用科学技术奖（2023，中国通信学会科学技术奖一等奖，第一完成人）',
        'awd.6': '面向通信行业的九天人工智能平台及应用（2020，中国通信学会科学技术奖二等奖，第一完成人）',
        'awd.7': '杰出主题演讲（2019，IEEE、IEEE计算机学会和IEEE通信学会大数据技术委员会）',
